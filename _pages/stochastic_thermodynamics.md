...
where $T$ is the temperature, $\sigma$ is the entropy production rate, $\epsilon = Var(\mathcal{J}_R)/\langle X\rangle^2$ is the precision, $t$ is the observation time and $k_B$ is the Boltzmann constant.
